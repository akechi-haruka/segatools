        ...
        const char *platform_id)
{
    ...
    nusec_nearfull = nusec_cfg.initial_nearfull;
    nusec_play_count = 0;
    nusec_play_limit = nusec_cfg.initial_playlimit;
...
static HRESULT nusec_ioctl_erase_trace_log(struct irp *irp)
{
    ...
    if (nusec_cfg.skip_trace_erase){
        dprintf("Security: skip_trace_erase enabled\n");
        //Only return status OK, this function makes the game crash after the first round anyway.
        return S_OK;
    }
